...
public class Lucknow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String l1[] = getResources().getStringArray(R.array.lucknow_hospital);
        String l2[] = getResources().getStringArray(R.array.lucknow_schools);
        String l3[] = getResources().getStringArray(R.array.lucknow_police);
        String l4[] = getResources().getStringArray(R.array.lucknow_fire);
        String l5[] = getResources().getStringArray(R.array.lucknow_gas);
        String l6[] = getResources().getStringArray(R.array.lucknow_entertainment);
